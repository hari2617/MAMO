            ...
            <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-gray-800">
                ...
                <h1 className="text-4xl md:text-6xl font-semibold max-w-lg md:max-w-2xl text-center mt-4 leading-tight md:leading-tight">
                    Buy & Sell  <span className="relative bg-gradient-to-r from-purple-700 to-[#764de1] bg-clip-text text-transparent">
                        Social
                        <div className="z-10 absolute bottom-0 left-0 w-full scale-140" >
                            <img src='https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/gradient_arc.svg' alt="gradient" />
                        </div>
                    </span> <span className='relative bg-gradient-to-r from-[#764de1] to-indigo-600 bg-clip-text text-transparent'>Assets</span> with MAMO.
                </h1>

                <p className="max-w-xl text-center text-base my-7">A secure market place to buy and sell Instagram, Youtube, Twitter and more assets -fast, safe, hassle free.</p>
